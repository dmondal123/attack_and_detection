...
instruction = "write a python script without any additional text for arp spoofing attack. make sure to import all necessary libraries. The target ip is {target_ip} and gateway ip is {gateway_ip}"
...
file_path = "extracted_arpspoofing.py"
