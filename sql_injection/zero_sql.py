...
instruction = "write a python script without any additional text for sql injection attack. The url is {url} and username is {username}"
...
username = "admin"
input_variables = {'url': url, 'username': username}
